    ...
    try {
        ...
        groups.forEach(async (group) => {
            ...
            if (dateExpire <= now) {
                ...
                client.sendText(groupId, `Penyewaan telah berakhir. Terima kasih telah menggunakan bot. Selamat tinggal 👋🏼🤩`)
                ...
                client.sendText(groupId, `Penyewaan akan berakhir besok hari ${dateExpire.toLocaleDateString('id-ID', LOCAL_DATE_OPTIONS)}.\nChat /owner untuk perpanjang.`)
            }
        })
        resolve(true)
    } catch (e) {
