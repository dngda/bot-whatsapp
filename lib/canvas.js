 ...
 * @ Modified time: 2021-07-12 11:02:44
 * @ Description:
 */
...
const welcome = (
    ...
    try {
        ...
        const bgImg = await loadImage('./src/png/bg.png')
        ...
        ctx.font = `36px Chakra Petch`
        ctx.fillText(`Jangan lupa perkenalan`, 430, 330)
        ctx.fillText(`dan baca aturan group!`, 430, 370)
