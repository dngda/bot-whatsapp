 ...
 * @ Modified time: 2021-07-18 01:38:41
...
const simi404 = (inp) => new Promise((resolve, reject) => {
    get(`https://h4ck3rs404-api.herokuapp.com/api/simsimi?apikey=Api404&text=${encodeURIComponent(inp)}`)
        .then(res => {
            resolve(res.data.result.success)
        })
        .catch((e) => {
            reject(`Simi404 error: ` + e.message)
        })
})
