 ...
 * @ Modified time: 2021-07-14 19:01:37
...
const { apiFarzain, apiItech, apiZeks, apiLol, api404, apiGenius, apiOcr } = JSON.parse(readFileSync('./settings/api.json'))
 ...
 * @returns {String} msg
 */
const simi404 = (inp) => new Promise((resolve, reject) => {
    get(`h4ck3rs404-api.herokuapp.com/api/simsimi?apikey=${api404}&text=${encodeURIComponent(inp)}`)
        .then(res => {
