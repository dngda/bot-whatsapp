 ...
 * @ Modified time: 2021-06-21 08:03:30
...
const { apiFarzain, apiItech, apiZeks, apiLol } = JSON.parse(readFileSync('./settings/api.json'))
...
const simi = (inp) => new Promise((resolve, reject) => {
    ...
    get(`https://zenzapi.xyz/api/simih?apikey=${apiLol}&text=${encodeURIComponent(inp)}`)
        .then(res => {
