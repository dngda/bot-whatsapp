 ...
 * @ Modified time: 2021-07-05 13:01:03
...
const facebookSaveFrom = (browser, url) => new Promise(async (resolve, reject) => {
	try {
		const page = await browser.newPage()
		await page.goto("https://en.savefrom.net/9-how-to-download-facebook-video.html")
		...
		// await page.waitForSelector("#sf_result > div > div.result-failure")
