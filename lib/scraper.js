 ...
 * @ Modified time: 2021-06-22 14:59:50
 ...
 */
const ssstik = (browser, url) => Promise(async (resolve, reject) => {
		try {
			const page = await browser.newPage()
 ...
 * @returns {Promise} `Promise` that resolve obj
 */
const snaptik = (browser, url) => Promise(async (resolve, reject) => {
		try {
			const page = await browser.newPage()
 ...
 * @returns {Promise} `Promise` that resolve obj
 */
const qload = (url) => Promise(async (resolve, reject) => {
		try {
