 ...
 * @ Modified time: 2021-07-18 23:36:48
...
const ttdl = (url) => new Promise(async (resolve, reject) => {
	fetch("https://ttdownloader.com/req/", {
		"headers": {
			"accept": "*/*",
			...
			"cookie": "PHPSESSID=0v7aql4almpuu32659ags643q0; popCookie=1"
		},
		"referrer": "https://ttdownloader.com/",
		"referrerPolicy": "strict-origin-when-cross-origin",
		"body": `url=${encodeURIComponent(url)}&format=&token=5609be8ee4e7df11013a21f2fdc7e3c789e49c33e5f28827bc319eca96710a32`,
		"method": "POST",
		"mode": "cors"
	}).then(res => res.text())
		.then(res => {
